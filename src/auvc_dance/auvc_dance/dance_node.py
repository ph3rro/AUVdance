...
class DanceNode(Node):
    def __init__(self):
        ...
        self.dance_routine = [
            ...
            Hops.hop(0.5, 500.0),
            [1.5, 0, 0, neutral, 0],
            Left.diagonal_right(1.0, 200.0, 500.0),
            [1.0, 0, 0, neutral, 0],
            Left.diagonal_left(1.0, 200.0, 500.0),
            [1.0, 0, 0, neutral, 0],
            Left.left(0.5, 500),
            [1.0, 0, 0, neutral, 0],
            Right.right(0.5, 500.0),
            [1.5, 0, 0, neutral, 0],
            Right.diagonal_right(3.0, 200.0, 600.0), #change to diagonal_left for other auv
            # CIRCLE
        ]
